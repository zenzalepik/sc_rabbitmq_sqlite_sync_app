...
echo -e "${CYAN}============================================================================${NC}"
echo -e " RabbitMQ Federation Setup - pc6 (192.168.1.15)"
echo -e "${CYAN}============================================================================${NC}"
echo ""
...
# Upstream: pc10 (192.168.1.19)
echo -e "  Adding upstream: pc10 -> 192.168.1.19"
rabbitmqctl set_parameter federation-upstream pc10 \
  '{"uri":"amqp://guest:guest@192.168.1.19:5672/", \
   ...
   "max-hops":1, \
   "prefetch-count":100}'
echo -e "${GREEN}  [OK]${NC} Upstream pc10 added"
echo ""
...
echo "  - Name: pc6"
echo "  - IP: 192.168.1.15"
echo "  - Hostname: pc6.local"
echo "  - Location: Office - Room 6"
echo ""
...
echo -e "${GREEN}✓ Federation setup complete for pc6!${NC}"
