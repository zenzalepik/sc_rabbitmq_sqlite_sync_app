...
REM  Node: pc5
REM  IP: 192.168.1.14
REM  Hostname: pc5.local
REM  Location: Office - Room 5
...
echo [96m============================================================================[0m
echo  RabbitMQ Federation Setup - pc5 (192.168.1.14)
echo [96m============================================================================[0m
echo.
...
echo   - Name: pc5
echo   - IP: 192.168.1.14
echo   - Hostname: pc5.local
echo   - Location: Office - Room 5
echo.
...
echo [92m✓ Federation setup complete for pc5![0m
echo.
pause
