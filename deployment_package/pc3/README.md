...
```batch
docker exec -it chat_app_pc3 python sync_chatting_app.py
```
...
|---------|-----|-------------|
| RabbitMQ AMQP | `192.168.1.12:5672` | guest/guest |
| RabbitMQ Management | http://192.168.1.12:15672 | guest/guest |
