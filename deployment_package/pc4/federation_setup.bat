...
REM  Node: pc4
REM  IP: 192.168.1.13
REM  Hostname: pc4.local
REM  Location: Office - Room 4
...
echo [96m============================================================================[0m
echo  RabbitMQ Federation Setup - pc4 (192.168.1.13)
echo [96m============================================================================[0m
echo.
...
echo   - Name: pc4
echo   - IP: 192.168.1.13
echo   - Hostname: pc4.local
echo   - Location: Office - Room 4
echo.
...
echo [92m✓ Federation setup complete for pc4![0m
echo.
pause
