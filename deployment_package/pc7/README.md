...
```batch
docker exec -it chat_app_pc7 python sync_chatting_app.py
```
...
|---------|-----|-------------|
| RabbitMQ AMQP | `192.168.1.16:5672` | guest/guest |
| RabbitMQ Management | http://192.168.1.16:15672 | guest/guest |
