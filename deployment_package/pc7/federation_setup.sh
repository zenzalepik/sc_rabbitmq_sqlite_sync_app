...
echo -e "${CYAN}============================================================================${NC}"
echo -e " RabbitMQ Federation Setup - pc7 (192.168.1.16)"
echo -e "${CYAN}============================================================================${NC}"
echo ""
...
echo "  - Hostname: pc7.local"
echo "  - Location: Office - Room 7"
echo ""
...
echo -e "${GREEN}✓ Federation setup complete for pc7!${NC}"
