...
echo ============================================================================
echo  RabbitMQ Federation Verification - pc10
echo ============================================================================
echo.
...
echo   Testing connection to pc4 (192.168.1.13)...
powershell -Command "Test-NetConnection -ComputerName 192.168.1.13 -Port 5672 -InformationLevel Quiet" >nul 2>&1
if %errorlevel% equ 0 (
    echo   [92m[OK][0m pc4 is reachable
) else (
    echo   [91m[FAIL][0m pc4 is NOT reachable
)
echo.
