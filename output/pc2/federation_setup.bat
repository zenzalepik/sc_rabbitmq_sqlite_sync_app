...
REM  Node: pc2
REM  IP: 192.168.1.11
REM  Hostname: pc2.local
REM  Location: Office - Room 2
REM  Generated: 2026-03-20 09:39:19
REM ============================================================================
REM
REM  Instructions:
...
echo [96m============================================================================[0m
echo  RabbitMQ Federation Setup - pc2 (192.168.1.11)
echo [96m============================================================================[0m
echo.
...
rabbitmqctl set_parameter federation-upstream pc8 ^
  "{\"uri\":\"amqp://guest:guest@192.168.1.17:5672/\", ^
   ...
   \"prefetch-count\":100}"
if %errorlevel% neq 0 (
    echo [93m[WARN][0m Failed to add upstream pc8
) else (
    echo [92m   [OK][0m Upstream pc8 added
)
echo.
...
echo   - Hostname: pc2.local
echo   - Location: Office - Room 2
echo.
...
echo [92m✓ Federation setup complete for pc2![0m
echo.
pause
