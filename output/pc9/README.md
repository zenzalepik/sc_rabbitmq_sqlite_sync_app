...
```batch
docker exec -it chat_app_pc9 python sync_chatting_app.py
```
...
|---------|-----|-------------|
| RabbitMQ AMQP | `192.168.1.18:5672` | guest/guest |
| RabbitMQ Management | http://192.168.1.18:15672 | guest/guest |
