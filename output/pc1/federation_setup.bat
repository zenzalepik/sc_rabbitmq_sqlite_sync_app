...
REM  Node: pc1
REM  IP: 192.168.1.10
REM  Hostname: pc1.local
REM  Location: Office - Room 1
...
echo [96m============================================================================[0m
echo  RabbitMQ Federation Setup - pc1 (192.168.1.10)
echo [96m============================================================================[0m
echo.
...
echo   - Hostname: pc1.local
echo   - Location: Office - Room 1
echo.
...
echo [92m✓ Federation setup complete for pc1![0m
echo.
pause
